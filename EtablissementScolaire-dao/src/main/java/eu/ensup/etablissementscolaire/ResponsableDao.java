...
public class ResponsableDao extends BaseDao implements IResponsableDao {
	...
	public Responsable getCredentialByEmail(String email) throws DaoException {
		...
		try {
			...
			while (getRs().next()){
				System.out.println("getRs().getInt(\"id_personne\") : " +  getRs().getInt("id_personne"));
				System.out.println("getRs().getInt(\"id_personne\") : " +  getRs().getInt("nom"));
				System.out.println("getRs().getInt(\"id_personne\") : " +  getRs().getInt("email"));
				System.out.println("getRs().getInt(\"id_personne\") : " +  getRs().getInt("adresse"));
				System.out.println("getRs().getInt(\"id_personne\") : " +  getRs().getInt("telephone"));
				System.out.println("getRs().getInt(\"id_personne\") : " +  getRs().getInt("prenom"));
				System.out.println("getRs().getInt(\"id_personne\") : " +  getRs().getInt("mdp"));
				System.out.println("getRs().getInt(\"id_personne\") : " +  getRs().getInt("salt"));
				R1 = new Directeur(getRs().getInt("id_personne"),getRs().getString("nom"),getRs().getString("email"),getRs().getString("adresse"),getRs().getString("telephone"), getRs().getString("prenom"),getRs().getString("mdp"),getRs().getString("salt"),null);

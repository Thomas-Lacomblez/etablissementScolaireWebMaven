...
(function(factory) {
    ...
    var Datepicker = function(element, options) {
        ...
        if (this._check_template(this.o.templates.leftArrow)) {
            this.picker.find('.prev').jsp(this.o.templates.leftArrow);
        }

        if (this._check_template(this.o.templates.rightArrow)) {
            this.picker.find('.next').jsp(this.o.templates.rightArrow);
        }
    ...
    Datepicker.prototype = {
        ...
        fill: function() {
            ...
            this.picker.find('.datepicker-days tbody').jsp(html.join(''));

...
--
-- Hôte : mysql
-- Généré le : mer. 12 mai 2021 à 07:44
...
(10, 'Lacomblez', 'email', '80 b rue de Chartres', '0634779411');
...
--
ALTER TABLE `matiere`
  MODIFY `id_matiere` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `personne_phys`
  MODIFY `id_phys` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
